...
#     attack_values               = unpack_kwargs(attack_specs,                    ['graph_type','attack_target_label','trigger_size','prob','K','frac'])
...
def build_explainer_metrics_dict(dataset_dict_backdoor,
                                 dataset_dict_clean,
                                 dataset,
                                 model,
                                 clean_success_indices_val,
                                 clean_success_indices,
                                 backdoor_success_indices,
                                 re_explain, 
                                 attack_specs,
                                 model_specs,
                                 classifier_hyperparams,
...
def get_explainer_metrics(model, 
    ...
    mask_feat_variance          = mask_feature_variance(explanation.node_mask)    
...
def try_metrics(dataset_dict_backdoor,
                dataset_dict_clean,
                dataset,
                cln_success_idxs_val, cln_success_idxs, bkd_success_idxs,
                model,
                asr,
                history,
                attack_specs,
